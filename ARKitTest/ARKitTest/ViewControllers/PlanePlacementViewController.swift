//
//  PlanePlacementViewController.swift
//  ARKitTest
//
...
class PlanePlacementViewController: BaseSceneViewController {
    ...
    private func addBox(forHitResult hitResult: ARHitTestResult) {
        ...
        let vector = SCNVector3(hitResult.worldTransform.columns.3.x,
                                hitResult.worldTransform.columns.3.y + Float(config.height / 2),
...
extension PlanePlacementViewController: ARSCNViewDelegate {
